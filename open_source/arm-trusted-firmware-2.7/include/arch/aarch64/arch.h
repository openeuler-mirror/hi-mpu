...
#if defined(TAISHAN_CORE)
#define MPIDR_CPU_MASK		(MPIDR_AFFLVL_MASK << 8)
#define MPIDR_CLUSTER_MASK	((MPIDR_AFFLVL_MASK << 16) & 0x70000)
#elif defined(HIBMC)
#define MPIDR_CPU_MASK		(MPIDR_AFFLVL_MASK << 8)
#define MPIDR_CLUSTER_MASK	(MPIDR_CLUSTER_ID_MASK << 16)
#else
...
#if defined(TAISHAN_CORE)
#define MPIDR_AFF0_SHIFT	U(8)
#define MPIDR_AFF1_SHIFT	U(16)
#elif defined(HIBMC)
#define MPIDR_AFF0_SHIFT	U(8)
#define MPIDR_AFF1_SHIFT	U(16)
#else
...
#if defined(TAISHAN_CORE)
#define MPIDR_AFFINITY_MASK U(0x07FFFF)
#elif defined(HIBMC)
#define MPIDR_AFFINITY_MASK	U(0x007FFFFF)
#else
...
#if defined(TAISHAN_CORE)
#define MPIDR_CLUSTER_ID_MASK   U(7)
#elif defined(HIBMC)
#define MPIDR_CLUSTER_ID_MASK   U(3)
#endif
...
#define MPIDR_AFFLVL1_VAL(mpidr) \
		(((mpidr) >> MPIDR_AFF1_SHIFT) & MPIDR_CLUSTER_ID_MASK)
#elif defined(HIBMC)
#define MPIDR_AFFLVL1_VAL(mpidr) \
		(((mpidr) >> MPIDR_AFF1_SHIFT) & MPIDR_CLUSTER_ID_MASK)
#else
...
#ifdef TAISHAN_CORE
#define FIRST_MPIDR		ULL(0x80000)
#endif
/*
