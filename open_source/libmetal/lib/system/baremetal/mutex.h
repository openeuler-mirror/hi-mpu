 ...
 */
/*
 * @file	baremetal/mutex.h
 * @brief	baremetal mutex primitives for libmetal.
 */
...
#ifndef __METAL_BAREMETAL_MUTEX__H__
#define __METAL_BAREMETAL_MUTEX__H__
...
#endif /* __METAL_BAREMETAL_MUTEX__H__ */
