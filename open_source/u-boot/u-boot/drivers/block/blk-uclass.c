...
#if defined(CONFIG_HI3093_SPI)
    [IF_TYPE_HI3093_SPI]      = "private_device",
#endif
#if defined(CONFIG_IF_PRIVATE_DEVICE)
    [IF_TYPE_PRIVATE_DEVICE]      = "private_device",
#endif
};
...
#if defined(CONFIG_HI3093_SPI)
    [IF_TYPE_HI3093_SPI]      = UCLASS_ROOT,
#endif
#if defined(CONFIG_IF_PRIVATE_DEVICE)
    [IF_TYPE_PRIVATE_DEVICE]      = UCLASS_ROOT,
#endif
};
