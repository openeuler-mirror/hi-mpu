 ...
 * In Linux, a timer that is being timed cannot be started.
 *
 ...
 * @param delay [in] the timers expiry time, unit: ms.
 *
 * @return OSAL_SUCCESS/OSAL_FAILURE
 *
 * @par Support System:
 ...
 *
 * @param hrtimer [in] the timer to be start.
 *
 ...
 *
 * @param hrtimer [in] The timer to be destroyed.
 *
 * @attention
 * If the pointer to the high-resolution timer is null or the timer node does not exist,
 * the structure is inconsistent with that during creation,
