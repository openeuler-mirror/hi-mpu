 ...
 * 2) Be greater than the size of min pool size of each system.\n
...
/**
 * @ingroup osal_addr
 * @brief Copying Data from User Space to Kernel Space.
 *
...
/**
 * @ingroup osal_addr
 * @brief Copying Data from Kernel Space to User Space.
 *
