 ...
 *
 * @param event_obj [in/out] Pointer to the event control block to be initialized.
 *
 ...
 *
 * @param event_obj [in/out] Pointer to the event control block to be written.
 * @param mask [in] Mask of the event to be written.
 *
 * @return OSAL_SUCCESS/OSAL_FAILURE
 *
 * @par Support System:
 ...
 * @param mask [in] Mask of the event to be cleared.
 *
 * @return OSAL_SUCCESS/OSAL_FAILURE
 *
 * @par Support System:
