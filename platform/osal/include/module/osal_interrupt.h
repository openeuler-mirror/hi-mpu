 ...
 *
 * @attention In linux userspace, the type of the dev parameter must be (drval_irq_arg *).
 *
 ...
 */
int osal_irq_request(unsigned int irq, osal_irq_handler irq_handler, osal_irq_handler thread_handler, const char *name,
    void *dev);
