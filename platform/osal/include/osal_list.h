 ...
 */
static inline void osal___list_add(struct osal_list_head *_new,
 ...
 * @head: the list to test
 *
 * Description: tests whether a list is empty _and_ checks that no other CPU might be
                                          ...
                                          struct osal_list_head *head, struct osal_list_head *entry)
{
    ...
    if (osal_list_is_singular(head) != 0 &&
